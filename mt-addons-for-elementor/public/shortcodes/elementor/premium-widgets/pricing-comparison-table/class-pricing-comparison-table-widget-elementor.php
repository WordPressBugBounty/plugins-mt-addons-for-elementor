<?php
class MT_Addons_Premium_Pricing_Comparison_Table extends \Elementor\Widget_Base {
    public function get_style_depends() {
        wp_enqueue_style( 'mt-addons-premium-pricing-comparison-table', plugin_dir_url( __FILE__ ).'css/pricing-comparison-table.css');
        return [
            'mt-addons-premium-pricing-comparison-table',
        ];
    } 
