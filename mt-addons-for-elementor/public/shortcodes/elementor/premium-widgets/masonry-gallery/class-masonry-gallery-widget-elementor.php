...
class MT_Addons_Premium_Masonry_Gallery extends \Elementor\Widget_Base {
    public function get_style_depends() {
        wp_enqueue_style( 'mt-addons-premium-masonry-gallery', plugin_dir_url( __FILE__ ).'css/masonry-gallery.css');
        wp_enqueue_style( 'magnificpopup', plugin_dir_url( __FILE__ ).'css/magnificPopup.css');
        return [
            'mt-addons-premium-masonry-gallery', 'magnificpopup'
        ];
    }
    public function get_script_depends() {
        wp_register_script( 'mt-addons-magnificpopup', plugin_dir_url( __FILE__ ).'js/magnificPopup/magnificPopup.js');
        wp_register_script( 'mt-addons-isotope', plugin_dir_url( __FILE__ ).'js/isotope/isotope.pkgd.js');
        wp_register_script( 'imagesLoaded', plugin_dir_url( __FILE__ ).'js/imagesLoaded/imagesloaded.pkgd.js');
        
        wp_register_script( 'mt-addons-premium-masonry-gallery', plugin_dir_url( __FILE__ ).'js/masonry-gallery.js');
        
        return [ 'jquery', 'elementor-frontend', 'mt-addons-isotope','imagesLoaded',  'mt-addons-magnificpopup','mt-addons-premium-masonry-gallery'];
    }
    ...
    {
        return esc_html__('MT Masonry Gallery', 'mt-addons');
    }
    ...
    private function all_controls() {
        ...
        $this->add_control(
            'gallery',
            array(
                'label'      => esc_html__( 'Add Gallery Images', 'mt-addons' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'          => esc_html__( 'Number Of Columns', 'mt-addons' ),
                'label_block'    => false,
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'          => esc_html__( 'Column Spacing', 'mt-addons' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Elements', 'mt-addons' ),
                'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
            )
        );
        ...
        $this->add_control(
            'title_show_select',
            array(
                'label'       => esc_html__( 'Show Title in', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => array(
                    'mtap-masonry-gallery-title-lightbox-only' => esc_html__( 'Lightbox', 'mt-addons' ),
                    'mtap-masonry-gallery-title-only'  => esc_html__( 'Gallery', 'mt-addons' ),
                    'mtap-masonry-gallery-title-both'          => esc_html__( 'Both', 'mt-addons' ),
                ),
        ...
        $this->add_control(
            'caption_switcher',
            array(
                'label'                => esc_html__( 'Show Caption', 'mt-addons' ),
                'separator'            => 'before',
                'type'                 => \Elementor\Controls_Manager::SWITCHER,
                'label_off'            => esc_html__( 'NO', 'mt-addons' ),
                'label_on'             => esc_html__( 'YES', 'mt-addons' ),
        ...
        $this->add_control(
            'caption_show_select',
            array(
                'label'       => esc_html__( 'Show Caption in', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => array(
                    'mtap-masonry-gallery-lightbox-only' => esc_html__( 'Lightbox', 'mt-addons' ),
                    'mtap-masonry-gallery-caption-only'  => esc_html__( 'Gallery', 'mt-addons' ),
                    'mtap-masonry-gallery-caption-both'  => esc_html__( 'Both', 'mt-addons' ),
                ),
        ...
        $this->add_control(
            'lightbox_switcher',
            array(
                'label'                => esc_html__( 'Enable Lightbox', 'mt-addons' ),
                'separator'            => 'before',
                'type'                 => \Elementor\Controls_Manager::SWITCHER,
                'label_off'            => esc_html__( 'NO', 'mt-addons' ),
                'label_on'             => esc_html__( 'YES', 'mt-addons' ),
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Title & Caption Style in Lightbox', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => array(
                    'mtap-masonry-gallery-img-ovl' => esc_html__( 'Image Overlay', 'mt-addons' ),
                    'mtap-masonry-gallery-img-blw' => esc_html__( 'Below Image', 'mt-addons' ),
                ),
        ...
        $this->add_control(
            ...
            array(
                'label'                => esc_html__( 'Overlay on Hover', 'mt-addons' ),
                'separator'            => 'before',
                'type'                 => \Elementor\Controls_Manager::SWITCHER,
                'label_off'            => esc_html__( 'NO', 'mt-addons' ),
                'label_on'             => esc_html__( 'YES', 'mt-addons' ),
        ...
        $this->add_control(
            'overlay_icon_select',
            array(
                'label'     => esc_html__( 'Overlay Icon', 'mt-addons' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Gallery Styling', 'mt-addons' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Image Rounded Corners', 'mt-addons' ),
        ...
        $this->add_control(
            'title_heading_level',
            array(
                'label'       => esc_html__( 'Title Heading Level', 'mt-addons' ),
                ...
                array(
                    'h1' =>
                        array(
                            'title' => esc_html__( 'H1', 'mt-addons' ),
                            'icon'  => 'eicon-editor-h1',
                        ),
                    'h2' =>
                        array(
                            'title' => esc_html__( 'H2', 'mt-addons' ),
                            'icon'  => 'eicon-editor-h2',
                        ),
                    'h3' =>
                        array(
                            'title' => esc_html__( 'H3', 'mt-addons' ),
                            'icon'  => 'eicon-editor-h3',
                        ),
                    'h4' =>
                        array(
                            'title' => esc_html__( 'H4', 'mt-addons' ),
                            'icon'  => 'eicon-editor-h4',
                        ),
                    'h5' =>
                        array(
                            'title' => esc_html__( 'H5', 'mt-addons' ),
                            'icon'  => 'eicon-editor-h5',
                        ),
                    'h6' =>
                        array(
                            'title' => esc_html__( 'H6', 'mt-addons' ),
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Title Text Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '',
                'selectors'   => array(
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'label'     => esc_html__( 'Title Text Shadow', 'mt-addons' ),
                'selector'  => '{{WRAPPER}} .mtap-masonry-gallery-item_title:hover',
                'separator' => 'before',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                'type'      => \Elementor\Controls_Manager::SLIDER,
                'label'     => esc_html__( 'Transition Duration (ms) ', 'mt-addons' ),
                'range'     => array(
                    'ms' => array(
                        'min'  => 0,
                        'max'  => 10000,
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Title Padding and Margin', 'mt-addons' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Caption', 'mt-addons' ),
                'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => array( 'caption_switcher' => 'yes' ),
            )
        );
        ...
        $this->add_control(
            'caption_text_color',
            array(
                'label'       => esc_html__( 'Caption Text Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#222',
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            array(
                'label'       => esc_html__( 'Caption Typography', 'mt-addons' ),
                'label_block' => true,
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'label'     => esc_html__( 'Caption Text Shadow', 'mt-addons' ),
                'selector'  => '{{WRAPPER}} .mtap-masonry-gallery-item_caption',
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Caption Alignment', 'mt-addons' ),
                'type'        => \Elementor\Controls_Manager::CHOOSE,
                'label_block' => true,
                'options'     => array(
                    'left'   => array(
                        'caption' => esc_html__( 'Left', 'mt-addons' ),
                        'icon'    => 'eicon-text-align-left',
                    ),
                    'center' => array(
                        'caption' => esc_html__( 'Center', 'mt-addons' ),
                        'icon'    => 'eicon-text-align-center',
                    ),
                    'right'  => array(
                        'caption' => esc_html__( 'Right', 'mt-addons' ),
                        'icon'    => 'eicon-text-align-right',
                    ),
                ),
                'default'     => is_rtl() ? 'right' : 'left',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Caption Padding and Margin', 'mt-addons' ),
                'type'  => \Elementor\Controls_Manager::HEADING,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Lightbox', 'mt-addons' ),
                'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Lightbox Background Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#0000006E',
                'selectors'   => array(
        ...
        $this->add_control(
            'exit_icon_color',
            array(
                'label'       => esc_html__( 'Exit Icon Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#ffffff',
                'selectors'   => array(
        ...
        $this->add_control(
            'arrow_border_color',
            array(
                'label'       => esc_html__( 'Arrow Border Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#FFFFFF75',
                'selectors'   => array(
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Title & Caption Background Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#FFFFFF75',
                'selectors'   => array(
        ...
        $this->add_control(
            'overlay_icon_color',
            array(
                'label'       => esc_html__( 'Overlay Icon Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#ffffff',
                'selectors'   => array(
        ...
        $this->add_control(
            'image_overlay_color',
            array(
                'label'       => esc_html__( 'Overlay Background Color', 'mt-addons' ),
                'label_block' => false,
                'type'        => \Elementor\Controls_Manager::COLOR,
                'default'     => '#0000006E',
                'selectors'   => array(
