!function($, $ele, $i) {
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, mtkitEditor.i18n)
    };
    ...
    $app.Behaviors.InsertTemplate = Marionette.Behavior.extend({
        ui: {
            insertButton: ".mtkitTemplateLibrary_insert-button"
        },
        events: {
    ...
    $app.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
        ...
        template: "#mtkit-modelthemekitTemplate_empty",
        ui: {
    ...
    $app.Views.Loading = Marionette.ItemView.extend({
        template: "#mtkit-modelthemekitTemplate_loading",
        id: "modelthemekitTemplate_loading"
    }), 
    $app.Views.Logo = Marionette.ItemView.extend({
        template: "#mtkit-modelthemekitTemplate_header-logo",
        className: "modelthemekitTemplate_header-logo",
    ...
    $app.Views.BackButton = Marionette.ItemView.extend({
        template: "#mtkit-modelthemekitTemplate_header-back",
        id: "elementor-template-library-header-preview-back",
        className: "modelthemekitTemplate_header-back",
        events: function() {
            return {
                click: "onClick"
            }
    ...
    $app.Views.Menu = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_header-menu",
        id: "elementor-template-library-header-menu",
        className: "modelthemekitTemplate_header-menu",
        templateHelpers: function() {
    ...
    $app.Views.ResponsiveMenu = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_header-menu-responsive",
        id: "elementor-template-library-header-menu-responsive",
        className: "modelthemekitTemplate_header-menu-responsive",
        ui: {
    ...
    $app.Views.Actions = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_header-actions",
        id: "elementor-template-library-header-actions",
        ui: {
            sync: "#modelthemekitTemplate_header-sync i"
        },
        events: {
    ...
    $app.Views.InsertWrapper = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_header-insert",
    ...
    $app.Views.Preview = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_preview",
        className: "modelthemekitTemplate_preview",
        ui: function() {
            return {
                img: "> img"
            }
        ...
        onRender: function() {
            ...
            this.$el.append(t.el), this.ui.img.on("load", function() {
                e.$el.find("#modelthemekitTemplate_loading").remove(), e.ui.img.show()
            })
        }
    }), 
    $app.Views.TemplateCollection = Marionette.CompositeView.extend({
        template: "#mtkit_TemplateLibrary_templates",
        id: "modelthemekitTemplate_templates",
        className: function() {
            return "modelthemekitTemplate_templates modelthemekitTemplate_templates--" + $i.library.getFilter("type")
        },
        childViewContainer: "#modelthemekitTemplate_templates-list",
        emptyView: function() {
            return new $app.Views.EmptyTemplateCollection
        },
        ui: {
            templatesWindow: ".modelthemekitTemplate_templates-window",
            textFilter: "#modelthemekitTemplate_search",
            tagsFilter: "#modelthemekitTemplate_filter-tags",
            filterBar: "#modelthemekitTemplate_toolbar-filter",
            counter: "#modelthemekitTemplate_toolbar-counter"
        },
        events: {
        ...
        onTagsFilterClick: function(t) {
            var a = $(t.currentTarget),
                n = a.data("tag");
            $i.library.setFilter("tags", n), a.addClass("active").siblings().removeClass("active"), n = n ? $i.library.getTags()[n] : "Filter", this.ui.filterBar.find(".modelthemekitTemplate_filter-btn").html(n + ' <i class="eicon-caret-down"></i>')
        },
        ...
        setTagsFilterHover: function() {
            ...
            e.ui.filterBar.hoverIntent(function() {
                e.ui.tagsFilter.addClass("modelthemekitTemplate_filter-show"), e.ui.filterBar.find(".modelthemekitTemplate_filter-btn i").addClass("eicon-caret-down").removeClass("eicon-caret-right")
            }, function() {
                e.ui.tagsFilter.removeClass("modelthemekitTemplate_filter-show");
                e.ui.tagsFilter.addClass("modelthemekitTemplate_filter-hide"), e.ui.filterBar.find(".modelthemekitTemplate_filter-btn i").addClass("eicon-caret-right").removeClass("eicon-caret-down")
            }, {
                sensitivity: 50,
                interval: 150,
                timeout: 100
    ...
    $app.Views.Template = Marionette.ItemView.extend({
        template: "#mtkit-TemplateLibrary_template",
        className: "modelthemekitTemplate_template",
        ui: {
            previewButton: ".modelthemekitTemplate_preview-button, .modelthemekitTemplate_template-preview"
        },
        events: {
    ...
    $app.Modal = elementorModules.common.views.modal.Layout.extend({
        getModalOptions: function() {
            return {
                id: "modelthemekitTemplate_modal",
                hide: {
                    onOutsideClick: !1,
                    onEscKeyPress: !0,
                    onBackgroundClick: !1
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !mtkitEditor.hasPro ? "pro-button" : "insert-button";
            return viewId = "#mtkit-TemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
        ...
        showDefaultHeader: function() {
            this.showLogo({
                title: "Modeltheme Kit Templates"
            });
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".dlmtkit_templates_add_button").length || $sl.find(mtkit_FIND_SELECTOR).before($mtkitPpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(mtkit_FIND_SELECTOR);
            $t.length && !$el.find(".dlmtkit_templates_add_button").length && $t.before($mtkitPpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }

        function onChanges(t, i) {
            i.addClass("elementor-active").siblings().removeClass("elementor-active");
            var a = $dlmtkitResponsiveMap[t] || $dlmtkitResponsiveMap.desktop;
            $(".modelthemekitTemplate_preview").css("width", a)
        }
        ...
        function onEditorLoaded() {
            var $el = window.elementor.$previewContents,
                ...
                $el.on("click.onAddTemplateButton", ".dlmtkit_templates_add_button", $this.showModal.bind($this)), this.channels.tabs.on("change:device", onChanges)
        }

        var o, s, d, c, m, $this = this;
        console.log( window );

        mtkit_FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", 
        $mtkitPpenLibraryButton = '<div class="elementor-add-section-area-button dlmtkit_templates_add_button"> <img src="'+mtkitEditor.templateLogo+'" /> </div>', 
        $dlmtkitResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
        }, 
        ...
        this.init = function() {
            $this.setFilter("type", mtkitEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
        }, 
        this.getTabs = function() {
            var e = this.getFilter("type");
            return tabs = JSON.parse(mtkitEditor.tab_style)
        ...
        this.requestLibraryData = function(e) {
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_mtkit_library_data", t)
        }, 
        this.requestTemplateData = function(e, t) {
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_mtkit_template_data", i)
        }, 
...
}(jQuery, window.elementor, window.mtkit || {});
